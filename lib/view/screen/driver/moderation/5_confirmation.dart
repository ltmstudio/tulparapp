...
class ModerationConfirmationScreen extends StatefulWidget {
  ...
  @override
  State<ModerationConfirmationScreen> createState() =>
      _ModerationConfirmationScreenState();
}

class _ModerationConfirmationScreenState
    extends State<ModerationConfirmationScreen> {
  ...
  final notSettedValue = Text.rich(TextSpan(text: "", children: [
    ...
    TextSpan(
        ...
        style: const TextStyle(
            fontSize: 16, fontWeight: FontWeight.w700, color: CoreColors.grey))
  ]));
  @override
        ...
        body: ListView(
          ...
          children: [
            ...
            Padding(
                ...
                child: Text('Имя'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
                child: moderation?.name != null
                    ? Text('${moderation?.name}'.tr, style: valueStyle)
                    : notSettedValue),
            Padding(
                padding: labelPadding,
                child: Text('Фамилия'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
            ...
            Padding(
                padding: labelPadding,
                child: Text('Дата рождения'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
                child: moderation?.birthdate != null
                    ? Text(
                        DateFormat('dd.MM.yyyy')
                            .format(moderation!.birthdate!)
                            .tr,
                        style: valueStyle)
                    : notSettedValue),
            // авто
            Padding(
                padding: labelPadding,
                child: Text('Марка авто'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
                child: moderation?.carId != null
                    ? Text('${moderation?.carId}'.tr, style: valueStyle)
                    : notSettedValue),
            Padding(
                padding: labelPadding,
                child: Text('Модель авто'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
            ...
            Padding(
                padding: labelPadding,
                child: Text('VIN'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
                child: moderation?.carVin != null
                    ? Text('${moderation?.carVin}'.tr, style: valueStyle)
                    : notSettedValue),
            Padding(
                padding: labelPadding,
                child: Text('Год выпуска'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
            ...
            Padding(
                padding: labelPadding,
                child: Text('Гос. номер'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
            ...
            Padding(
                padding: labelPadding,
                child: Text('Фото авто'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
                child: moderation?.carImages.entries
                            .where((e) => e.value != null)
                            .isNotEmpty ??
                        false
                    ? Text(
                        '${moderation?.carImages.entries.where((e) => e.value != null).length} фото'
                            .tr,
                        style: valueStyle)
                    : notSettedValue),
            ...
            Padding(
                padding: labelPadding,
                child: Text('Номер вод. удостоверения'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
                child: moderation?.driverLicenseNumber != null
                    ? Text('${moderation?.driverLicenseNumber}'.tr,
                        style: valueStyle)
                    : notSettedValue),
            Padding(
                padding: labelPadding,
                child: Text('Дата выдачи'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
                child: moderation?.driverLicenseDate != null
                    ? Text(
                        DateFormat('dd.MM.yyyy')
                            .format(moderation!.driverLicenseDate!)
                            .tr,
                        style: valueStyle)
                    : notSettedValue),
            Padding(
                padding: labelPadding,
                child: Text('Фото вод. удостоверения'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
                child: moderation?.driverLicenseFront != null &&
                        moderation?.driverLicenseBack != null
                    ? Text('2 фото'.tr, style: valueStyle)
                    : notSettedValue),
            // тех. паспорт
            Padding(
                padding: labelPadding,
                child: Text('Фото тех. паспорта'.tr, style: labelStyle)),
            Padding(
                padding: valuePadding,
                child: moderation?.tsPassportFront != null &&
                        moderation?.tsPassportBack != null
                    ? Text('2 фото'.tr, style: valueStyle)
                    : notSettedValue),
            const Divider(),
            Text(

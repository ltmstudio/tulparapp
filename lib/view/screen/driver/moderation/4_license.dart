...
class ModerationLicenseScreen extends StatefulWidget {
  ...
  @override
  State<ModerationLicenseScreen> createState() =>
      _ModerationLicenseScreenState();
}
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    for (var field
                        in moderationController.driverLicenseImagesFields)
                      Padding(
              ...
              Padding(
                  padding: const EdgeInsets.only(top: 15),
                  child: Text(
                      'Фото Тех. паспорта (Передняя и задняя стороны)'.tr,
                      style: const TextStyle(
                          fontSize: 12, fontWeight: FontWeight.w700))),
              SizedBox(
                height: 146,

...
GeoRouteModel geoRouteModelFromJson(String str) =>
    GeoRouteModel.fromJson(json.decode(str));
...
class GeoRoute {
  ...
  String get distanceInKilometers =>
      ((distance ?? 0) / 1000).toStringAsFixed(1);
  ...
  factory GeoRoute.fromJson(Map<String, dynamic> json) => GeoRoute(
        geometry: json["geometry"] == null
            ? null
            : GeoGeometry.fromJson(json["geometry"]),
        legs: json["legs"] == null
            ? []
            : List<GeoLeg>.from(json["legs"]!.map((x) => GeoLeg.fromJson(x))),

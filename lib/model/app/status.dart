...
AppStatusModel appStatusModelFromJson(String str) =>
    AppStatusModel.fromJson(json.decode(str));
...
class AppStatusModel {
  ...
  factory AppStatusModel.fromJson(Map<String, dynamic> json) => AppStatusModel(
        ...
        orderTypes: json["orderTypes"] == null
            ...
            : List<OrderTypeModel>.from(
                json["orderTypes"]!.map((x) => OrderTypeModel.fromJson(x))),
        carClasses: json["carClasses"] == null
            ? []
            : List<CarClassModel>.from(
                json["carClasses"]!.map((x) => CarClassModel.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "carClasses": carClasses == null
            ? []
            : List<dynamic>.from(carClasses!.map((x) => x.toJson())),
      };
}

...
String availableShiftsResponseModelToJson(AvailableShiftsResponseModel data) =>
...
class AvailableShiftsResponseModel {
  ...
  factory AvailableShiftsResponseModel.fromJson(Map<String, dynamic> json) =>
      AvailableShiftsResponseModel(
        shifts: json["shifts"] == null
            ? []
            : List<ShiftPriceModel>.from(
                json["shifts"]!.map((x) => ShiftPriceModel.fromJson(x))),
